export const enUS = {
  ...
  auth: {
    ...
    save: "Save",
    forgotMessage: "Enter your registered email below and you will receive an email to create a new password.",
    checkYourEmail: "Request sent. Check your email",
    newPasswordSaved: "New password set.",
    confirmPassword: "Confirm password",
    confirmPasswordMessage: "Password not matching",
  },
  errorMessages: {
