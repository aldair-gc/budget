...
export default function Budget() {
  ...
  function updateBalance(data: { type: string; total: any }[][]) {
    ...
    data.forEach((month) => {
      ...
      month &&
        month.forEach((list: { type: string; total: any }) => (previousExpenditures += list.type === "expenditure" ? list.total : 0));
    });
  ...
  return (
    <BudgetContainer>
      ...
      <Totals incomeList={incomeList} expenditureList={expenditureList} lastMonthBalance={balance} />
    </BudgetContainer>
  );
}
