                          ...
                          <div className="config-item-options">
                            <label htmlFor="real">
                              <input
                                ...
                                name="currency"
                                id="real"
                                onClick={() => setCountry("en-US")}
                                defaultChecked={country === "en-US"}
                              />
                              {file.settings.dolar}
                            </label>
                            ...
                            <label htmlFor="dolar">
                              <input
                                ...
                                name="currency"
                                id="dolar"
                                onClick={() => setCountry("pt-BR")}
                                defaultChecked={country === "pt-BR"}
                              />
                              {file.settings.real}
                            </label>
                          </div>
